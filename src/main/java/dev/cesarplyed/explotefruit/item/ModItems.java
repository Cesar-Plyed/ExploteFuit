...
import dev.cesarplyed.explotefruit.item.custom.ExplosiveFruitItem;
...
public class ModItems {
    ...
    // 1. Baya Explosiva
    // Usamos nuestra clase personalizada 'ExplosiveFruitItem' para que explote al
    // comer.
    ...
    // 2. Baya de Fuego
    // Por ahora usa la misma lógica de explosión.
    public static final Item FIRE_BERRY = registerItem("fire_berry", ExplosiveFruitItem::new,
            new Item.Settings().food(EXPLOSIVE_FOOD_COMPONENT));

    // 3. Baya de Trueno
    // Por ahora usa la misma lógica de explosión.
    public static final Item THUNDER_BERRY = registerItem("thunder_berry", ExplosiveFruitItem::new,
            new Item.Settings().food(EXPLOSIVE_FOOD_COMPONENT));
